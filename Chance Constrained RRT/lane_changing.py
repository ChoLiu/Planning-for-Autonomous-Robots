...
def generateMap(res=0.2):
    ...
    #  rectangle
    cv2.rectangle(mymap,
                  (round(50*res), round(110*res)), # 5 x 20
                  (round(58*res), round(116*res)),
                  (0, 0, 0), -1)
    cv2.rectangle(mymap,
                  (round(60*res), round(70*res)), # 5 x 20
                  (round(68*res), round(76*res)),
                  (0, 0, 0), -1)
    cv2.rectangle(mymap,
                  (round(45*res), round(30*res)), # 5 x 20
                  (round(53*res), round(36*res)),
                  (0, 0, 0), -1)

    cv2.rectangle(mymap,
                  (round(110*res), round(110*res)), # 5 x 20
                  (round(118*res), round(116*res)),
                  (0, 0, 0), -1)
    cv2.rectangle(mymap,
                  (round(90*res), round(70*res)), # 5 x 20
                  (round(98*res), round(76*res)),
                  (0, 0, 0), -1)
    cv2.rectangle(mymap,
                  (round(100*res), round(30*res)), # 5 x 20
                  (round(108*res), round(36*res)),
                  (0, 0, 0), -1)
   
    cv2.rectangle(mymap,
                  (round(160*res), round(110*res)), # 5 x 20
                  (round(168*res), round(116*res)),
                  (0, 0, 0), -1)
    cv2.rectangle(mymap,
                  (round(170*res), round(70*res)), # 5 x 20
                  (round(178*res), round(76*res)),
                  (0, 0, 0), -1)
    cv2.rectangle(mymap,
                  (round(150*res), round(30*res)), # 5 x 20
                  (round(158*res), round(36*res)),
                  (0, 0, 0), -1)
...
def rrtPlanning_nonholo(mymap, goal, start, stepSize, rpm):
    ...
    for i in range(50000):
        ...
        if (newNode[0] - goal[0])**2 <= 100 and newNode[1] > goal[1] and int(orientation[newNode]*100) % 628 < 20:
...
if __name__ == "__main__":
    ...
    goal_ = setNode(115, 195, res_) # Top goal
